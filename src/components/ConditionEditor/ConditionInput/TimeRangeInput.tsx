  ...
  return (
    <form>
      <input
        ...
        onChange={e =>
          onChange({ ...condition, startHour: parseInt(e.target.value) || 0 })
        }
      />
      ...
      <input
        ...
        onChange={e =>
          onChange({ ...condition, startMinute: parseInt(e.target.value) || 0 })
        }
      />
      ...
      <input
        ...
        onChange={e =>
          onChange({ ...condition, endHour: parseInt(e.target.value) || 0 })
        }
      />
      <span className='text-secondary self-center'>&nbsp;시&nbsp;</span>
      <input
        ...
        onChange={e =>
          onChange({ ...condition, endMinute: parseInt(e.target.value) || 0 })
        }
      />
